...
CREATE TABLE Schedule (
    ...
    FirstDepartureTime TIME NOT NULL, -- First departure time
    LastDepartureTime TIME NOT NULL, -- Last departure time
...
CREATE TABLE Taxi (
    ...
    StartTime TIME NOT NULL, -- Start time of the taxi shift
    FinishTime TIME NOT NULL, -- Finish time of the taxi shift
    PRIMARY KEY (TaxiID)
);
